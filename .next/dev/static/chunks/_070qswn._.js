...
"[project]/components/cart/CartButton.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CartButton() {
    _s();
    const itemCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])({
        "CartButton.useCartStore[itemCount]": (s)=>s.itemCount
    }["CartButton.useCartStore[itemCount]"]);
    const total = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cart$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCartStore"])({
        "CartButton.useCartStore[total]": (s)=>s.total
...
_s(CartButton, "ZjwTLD7/sfQ+1fAEf9HVoFUMQ7k=", false, function() {
    return [
...
//# sourceMappingURL=_070qswn._.js.map